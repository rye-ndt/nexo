...
import type {TemplateDraft} from '@/features/templates/types'
...
export function useTemplateHelper(onFilled: (filled: TemplateDraft, sent: TemplateDraft) => void) {
    const {data} = useQuery({
        queryKey: HELPER_KEY,
