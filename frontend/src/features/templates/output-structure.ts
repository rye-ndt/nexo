/**
 * The grammar for a template's structured output, and the checker that runs
 * before the template can be saved. The structure is raw text a person typed,
...
/** The problems templateIssues shows, already carrying their line numbers. */
