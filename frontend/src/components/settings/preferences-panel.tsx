import {
    ...
    EFFORT_COLUMN,
    MODEL_COLUMN,
} from '@/components/settings/agent-default-row'
import {useAgentDefaults} from '@/hooks/use-agent-defaults'
import type {ThinkingLevel} from '@/lib/enums'
import {cn} from '@/lib/utils'
import type {AgentDefault} from '@/types/settings'

export function PreferencesPanel() {
    const {defaults, options, loading, error, pendingTaskLevel, setAgentDefault} = useAgentDefaults()
